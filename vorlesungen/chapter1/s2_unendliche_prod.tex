...
Für ein unendliches Produkt $\prod_{n=1} ^\infty p_n$ gilt:
\begin{enumerate}
...
\emph{Problem:} Gegeben $S\subset \CC$ diskret. Zu jedem $s\in S$ sei ein $m_s \in \NN$ gegeben.
...
\[
	...
	\end{cases}
\]
wobei die Produkte rechts \myemph[Weierstraß-Produkt]{Weierstraß-Produkte} genannt werden, diese sind auf Kompakta $K\subset \CC$ unbedingt konvergent.
\end{satz-list}

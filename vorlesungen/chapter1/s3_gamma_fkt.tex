...
\begin{satz-list}[Eulersches Integral]\label{satz:eulerint}\index{Gamma-Funktion!Eulersches Integral}
...
\]
mit einer Funktion $H(z)$, welche in jedem Winkelbereich (siehe \autoref{fig:Winkelbereich})
\[
	W_\delta
...
\begin{figure}
\begin{center}
	\includestandalone{vorlesungen/chapter1/images/winkelbereich}
	\caption{Der Winkelbereich $W_\delta$}

...
\begin{satz}[Stirlingsche Formel]\label{satz:stirling}\leavevmode
\begin{enumerate}
...
\begin{lemm}\label{lemma:stirling:hl3}
Sei
\[
	H(z)
...
\begin{bewe}[Stirlingsche Formel \autoref{satz:stirling}]\leavevmode
\begin{enumerate}

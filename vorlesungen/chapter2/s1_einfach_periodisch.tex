...
\begin{defi}
Sei $D \subseteq \CC$. Es gebe ein $\omega \in \CC\setminus\{0\}$ derart, dass aus $z\in D$ folgt, dass $z+\omega \in D$. Sei $f\colon D\ra \CC$. Gilt dann $f(z+\omega) = f(z)$ für alle $z \in D$, so heißt $f$ \myemph{einfach periodisch} mit Periode $\omega$.
\end{defi}

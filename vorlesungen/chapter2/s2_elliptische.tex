...
\begin{center}
	\begin{subfigure}[t]{0.45\textwidth}
		\includestandalone[width=.9\textwidth]{vorlesungen/chapter2/images/gitter}
		\caption{Gitter mit Basis $\omega_1 = 1$, $\omega_2 = i$}
	\end{subfigure}%
	\begin{subfigure}[t]{0.45\textwidth}
		\includestandalone[width=.9\textwidth]{vorlesungen/chapter2/images/gitter2}
...
\begin{satz}[1. Liouville'scher Satz]\label{satz:liouville-1}
...
\begin{satz}[2. Liouville'scher Satz]\label{satz:liouville-2}
Sei $f \in K(L)$.
Dann gilt
\[
...
\begin{figure}
\begin{center}
	\includestandalone{vorlesungen/chapter2/images/fundamentalmasche}
...
\begin{satz}[3. Liouville'scher Satz]\label{satz:liouville-3}
...
\begin{satz}[4. Liouville'scher Satz]\label{satz:liouville-4}
